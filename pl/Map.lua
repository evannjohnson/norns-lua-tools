...
local tablex = require 'tools.pl.tablex'
local utils = require 'tools.pl.utils'
local stdmt = utils.stdmt
local deepcompare = tablex.deepcompare

local pretty_write = require 'tools.pl.pretty' . write
local Map = stdmt.Map
local Set = stdmt.Set

local class = require 'tools.pl.class'
...
local function makelist(t)
    return setmetatable(t, require('tools.pl.List'))
end
